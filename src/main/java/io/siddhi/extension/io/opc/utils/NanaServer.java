...
import static io.siddhi.extension.io.opc.utils.GenerateOpcCert.getOPCCertByAppName;
...
class NanoServer {
    ...
    static class NanoServerExample extends Server implements SessionServiceSetHandler {
        ...
        public NanoServerExample(Application application) throws Exception {
            ...
            //自定义生成证书
            KeyPair myServerApplicationInstanceCertificate = getOPCCertByAppName("ServerExample1");
            ...
            datatypeMap = new HashMap<NodeId, Class<?>>() {
                {
                    put(Identifiers.Boolean, Boolean.class);
                }
            };
            //////////////////////////////////////
        }
